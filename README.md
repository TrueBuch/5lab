...
**Тема:** Работа с Excel, LINQ-запросы и консольное приложение

---

## Цель работы

Разработать консольное приложение с дружественным интерфейсом, реализующее работу с базой данных, хранящейся в Excel-файле.
Программа должна поддерживать загрузку, просмотр, добавление, удаление данных, выполнение LINQ-запросов и сохранение изменений обратно в Excel.
